...
<head>
    ...
    <link href="${basePath}/plugins/bootstrap-select-1.12.4/dist/css/bootstrap-select.min.css" rel="stylesheet">
            ...
            <div class="main_cont">
                <div class="common_info order_details mt20">
                    <ul class="nav nav-tabs" role="tablist">
                        <li role="presentation" class="active"><a href="initSetting.htm?menuId=1&menuParentId=1926&myselfId=2489">菜单列表</a></li>
                        <li role="presentation"><a href="allversion.htm?menuId=1&menuParentId=1926&myselfId=2173">更新日志</a></li>
                    </ul>
...
<div class="modal fade" id="addMenu"  role="dialog">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form role="form" class="form-horizontal" id="saveCate" action="savePage.htm?active=0&CSRFToken=${token }" method="post">
...
<script src="${basePath}/plugins/bootstrap-select-1.12.4/dist/js/bootstrap-select.min.js"></script>
<script src="${basePath}/js/ztree/jqtreetable.js"></script>
...
//        });
    ...
    function addmenu(){
        ...
        $('#addMenu').find("form").attr("action",'savePage.htm?active=0');
        $('#addMenu').modal('show');
    }
    ...
    function editmenu(cateId)
    {
        $.get("queryPageById.htm?pageId=" + cateId+"&CSRFToken=${token}", function (data)
        {
            ...
            removeChildNodesTree($("#update_id").val());
    ...
    function removeChildNodesTree(updateId)
    {
        var treeObj = $.fn.zTree.getZTreeObj("treeDemo");
        var node = treeObj.getNodeByParam("id", updateId, null);
